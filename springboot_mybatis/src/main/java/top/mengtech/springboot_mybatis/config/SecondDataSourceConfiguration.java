...
/**
 * @ClassName SecondDataSourceConfiguration
 * @Description
 * @Author MQM
...
@Configuration
@MapperScan(basePackages = "top.mengtech.springboot_mybatis.mapper.second", sqlSessionTemplateRef  = "secondSqlSessionTemplate")
